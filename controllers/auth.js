...
exports.forgotPassword = asyncHandler(async (req, res, next) => {
  ...
  // Update this message if there is a link to a front-end to update password instead.
...
const sendTokenResponse = (user, statusCode, res) => {
  ...
  const options = {
    expires: new Date(
      Date.now() + process.env.JWT_COOKIE_EXPIRE * 24 * 60 * 60 * 1000 // Calulates 30 days
    ),
    httpOnly: true,
  };
